        ...
        <section className="col-span-5 ">
            ...
            <div className="max-w-screen-xl py-6">
                <div className="max-w-lg">
                    <h1 className="text-2xl font-bold sm:text-3xl">Add Desimination</h1>
                </div>
                ...
                <form action="#" className="mb-0 mt-8 max-w-md space-y-4">
                    ...
                    <div className="flex items-center justify-end gap-4">
                        <p className="text-sm text-gray-500">
                            <Link className="underline" to="/research/desimination">Cancel</Link>
                        </p>
...
export default AddDesimination