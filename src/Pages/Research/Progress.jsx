                        ...
                        <table className="min-w-full divide-y-2 divide-gray-200 bg-white text-sm">
                            ...
                            <tbody className="divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    <td className="whitespace-nowrap px-4 py-2 font-medium text-gray-900">
                                        <div className='w-full  bg-gray-100 rounded-3xl h-2.5 '>
                                            <div className='bg-indigo-600 h-2.5 rounded-3xl' style={ { width: "70%" } }></div>
                                        </div>
                                    </td>
                                    <td className="whitespace-nowrap px-4 py-2 text-gray-700">
                                        <a href="#" className="bg-teal-700 text-white p-1 rounded-md">Update</a>
                                ...
                                <tr>
                                    ...
                                    <td className="whitespace-nowrap px-4 py-2 font-medium text-gray-900">
                                        <div className='w-full  bg-gray-100 rounded-3xl h-2.5 '>
                                            <div className='bg-indigo-600 h-2.5 rounded-3xl' style={ { width: "50%" } }></div>
                                        </div>
                                    </td>
                                    <td className="whitespace-nowrap px-4 py-2 text-gray-700">
                                        <a href="#" className="bg-teal-700 text-white p-1 rounded-md">Update</a>
                                ...
                                <tr>
                                    ...
                                    <td className="whitespace-nowrap px-4 py-2 font-medium text-gray-900">
                                        <div className='w-full  bg-gray-100 rounded-3xl h-2.5 '>
                                            <div className='bg-indigo-600 h-2.5 rounded-3xl' style={ { width: "10%" } }></div>
                                        </div>
                                    </td>
                                    <td className="whitespace-nowrap px-4 py-2 text-gray-700">
                                        <a href="#" className="bg-teal-700 text-white p-1 rounded-md">Update</a>
                                ...
                                <tr>
                                    ...
                                    <td className="whitespace-nowrap px-4 py-2 font-medium text-gray-900">
                                        <div className='w-full  bg-gray-100 rounded-3xl h-2.5 '>
                                            <div className='bg-indigo-600 h-2.5 rounded-3xl' style={ { width: "90%" } }></div>
                                        </div>
                                    </td>
                                    <td className="whitespace-nowrap px-4 py-2 text-gray-700">
                                        <a href="#" className="bg-teal-700 text-white p-1 rounded-md">Update</a>
